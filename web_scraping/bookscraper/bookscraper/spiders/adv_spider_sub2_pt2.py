# continuation of 'adv_spider_sub2' spider script where we implenent same proxy url functionality but using middlewares. 
...
class AdvSpiderSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for book in books : 
            ...
            yield scrapy.Request(url = relative_url, callback = self.parse_book_page
                                 )    
